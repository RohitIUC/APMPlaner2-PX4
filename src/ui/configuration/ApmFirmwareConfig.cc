...
void ApmFirmwareConfig::requestFirmwares(QString type, QString autopilot, bool notification = false)
{
    ...
    else if ((autopilot == "px4") || (autopilot == "px4-v2") || (autopilot == "px4-v4"))
    {
         ...
         * stable and beta both still support, as they are not 3.3 yet
         */
        QString prepathRover = "https://firmware.ardupilot.org/Rover/stable-3.4.2/" + prestring;
        m_buttonToUrlMap[ui.roverPushButton] = prepathRover + "/ArduCopter" + poststring + ".px4";

        QString prepathPlan = "https://firmware.ardupilot.org/Plane/stable-3.9.10/" + prestring;
        m_buttonToUrlMap[ui.planePushButton] = prepathPlan + "/ArduCopter" + poststring + ".px4";

        QString prepath = "https://firmware.ardupilot.org/Copter/stable-3.4.6/" + prestring;
        m_buttonToUrlMap[ui.copterPushButton] = prepath + "-heli/ArduCopter" + poststring + ".px4";
        ...
        makeNetworkRequest(QUrl(prepath + "-tri/git-version.txt"));
        makeNetworkRequest(QUrl(prepath + "-y6/git-version.txt"));
        makeNetworkRequest(QUrl(prepathRover + "/git-version.txt"));
        makeNetworkRequest(QUrl(prepathPlan + "/git-version.txt"));
    }
    else if(autopilot == "px4-v5")
    {
